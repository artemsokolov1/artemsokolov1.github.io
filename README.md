...
- **Первая игра** — когда выйдет, замените блок-заглушку на обычную плитку
  по шаблону из HTML-комментария в разделе «Игры» и положите обложку
  в `assets/img/projects/`.
